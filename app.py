...
def build_yearly_project_data(repositories):
    ...
    repository_timeline() so the yearly graph
    still works when timeline data is unavailable.
    """
...
if analyze:
    ...
    try:
        ...
        # Make sure features is always a dictionary.
        if not isinstance(
            features,
            dict
        ):
...
if analyze:
    ...
    # ========================================================
    # FIRST: BUILD YEARLY DATA DIRECTLY
    # ========================================================
    ...
    with st.expander(
        ...
        # IMPORTANT:
        # Use feature_name instead of feature.
        # This prevents the "feature" variable error.
